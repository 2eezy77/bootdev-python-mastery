...
# comparing two lists using len() range loop and comparison operators with list[i] incrementation.
- Userful when comparing old player levels with new player levels and seeing which list items have changed.
